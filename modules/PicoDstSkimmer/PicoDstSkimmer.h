...
protected:
	...
	void makeHistograms(){
		...
		hMeanRunN01 = new TH2D( "hMeanRunN01" , " dEdx vs run number, Mom .3 to .4, phi 2.55 to 2.60, + charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN04 = new TH2D( "hMeanRunN04" , " dEdx vs run number, Mom .3 to .4, phi 2.55 to 2.60, - charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN07 = new TH2D( "hMeanRunN07" , " dEdx vs run number, Mom .3 to .4, phi 2.55 to 2.60, #pm charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN08 = new TH2D( "hMeanRunN08" , " dEdx vs run number, Mom .3 to .4, phi 2.55 to 2.60, #pm charge, + eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN09 = new TH2D( "hMeanRunN09" , " dEdx vs run number, Mom .3 to .4, phi 2.55 to 2.60, #pm charge, - eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );


		hMeanRunN11 = new TH2D( "hMeanRunN11" , " dEdx vs run number, Mom .3 to .4, phi 1.55 to 1.60, + charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN14 = new TH2D( "hMeanRunN14" , " dEdx vs run number, Mom .3 to .4, phi 1.55 to 1.60, - charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN17 = new TH2D( "hMeanRunN17" , " dEdx vs run number, Mom .3 to .4, phi 1.55 to 1.60, #pm charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN18 = new TH2D( "hMeanRunN18" , " dEdx vs run number, Mom .3 to .4, phi 1.55 to 1.60, #pm charge, + eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN19 = new TH2D( "hMeanRunN19" , " dEdx vs run number, Mom .3 to .4, phi 1.55 to 1.60, #pm charge, - eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );


		hMeanRunN21 = new TH2D( "hMeanRunN21" , " dEdx vs run number, Mom .3 to .4, phi -1.90 to -1.85, + charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN24 = new TH2D( "hMeanRunN24" , " dEdx vs run number, Mom .3 to .4, phi -1.90 to -1.85, - charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN27 = new TH2D( "hMeanRunN27" , " dEdx vs run number, Mom .3 to .4, phi -1.90 to -1.85, #pm charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN28 = new TH2D( "hMeanRunN28" , " dEdx vs run number, Mom .3 to .4, phi -1.90 to -1.85, #pm charge, + eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN29 = new TH2D( "hMeanRunN29" , " dEdx vs run number, Mom .3 to .4, phi -1.90 to -1.85, #pm charge, - eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );


		hMeanRunN31 = new TH2D( "hMeanRunN31" , " dEdx vs run number, Mom .3 to .4, phi -3.00 to -2.95, + charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN34 = new TH2D( "hMeanRunN34" , " dEdx vs run number, Mom .3 to .4, phi -3.00 to -2.95, - charge, #pm eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		...
		hMeanRunN37 = new TH2D( "hMeanRunN37" , " dEdx vs run number, Mom .3 to .4, phi -3.00 to -2.95, #pm charge, #pm eta; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN38 = new TH2D( "hMeanRunN38" , " dEdx vs run number, Mom .3 to .4, phi -3.00 to -2.95, #pm charge, + eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
		hMeanRunN39 = new TH2D( "hMeanRunN39" , " dEdx vs run number, Mom .3 to .4, phi -3.00 to -2.95, #pm charge, - eta ; run number ; dE/dx ", 2751, 1, 2751, 1000, 0, 20 );
...
//			if( track->pMom().phi() > 2.60 ) continue;
			...
			hetaphi->Fill( track->pMom().phi(), track->pMom().pseudoRapidity() );
