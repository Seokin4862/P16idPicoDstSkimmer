...
for( int i = 8; i < 41; i++ ){
  ...
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for All Charge " << .05*(i-1) << " to " << .05*(i) << " Kaon Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 11; i < 36; i++ ){
  ...
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for Positive Charge " << .01*(i-1) << " to " << .01*(i) << " Kaon Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 8; i < 41; i++ ){
  ...
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for Positive Charge " << .05*(i-1) << " to " << .05*(i) << " Kaon Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 8; i < 41; i++ ){
  ...
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for Negative Charge " << .05*(i-1) << " to " << .05*(i) << " Kaon Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 8; i < 41; i++ ){
  stringstream name;
  name << "InvbptPria" << i+28;
  int n1 = hInvBeta->GetXaxis()->FindBin( .05*(i-1) );
  int n2 = hInvBeta->GetXaxis()->FindBin( .05*(i) );
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for All Charge " << .05*(i-1) << " to " << .05*(i) << " Proton Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 8; i < 41; i++ ){
  stringstream name;
  name << "InvbptPrip" << i+28;
  int n1 = hInvBeta->GetXaxis()->FindBin( .05*(i-1) );
  int n2 = hInvBeta->GetXaxis()->FindBin( .05*(i) );
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for Positive Charge " << .05*(i-1) << " to " << .05*(i) << " Proton Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
...
for( int i = 8; i < 41; i++ ){
  stringstream name;
  name << "InvbptPrin" << i+28;
  int n1 = hInvBeta->GetXaxis()->FindBin( .05*(i-1) );
  int n2 = hInvBeta->GetXaxis()->FindBin( .05*(i) );
  TH1 *hist = hInvBeta->ProjectionY( name.str().c_str() , n1 , n2 );
  stringstream histtitle;
  histtitle << "1/Beta for Momentum Range for Negative Charge " << .05*(i-1) << " to " << .05*(i) << " Proton Centered" ;
  hist->SetTitle( histtitle.str().c_str() );
  hist->SetYTitle( "Number of Tracks" );
  hist->Write();
  hist->Draw();
