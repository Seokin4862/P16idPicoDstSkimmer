...
h2_1->SetYTitle( "dE/dx" );
h2_1->SetAxisRange( 2.6, 2.9, "Y" );
h2_1->SetAxisRange( 1350, 1900, "X" );
h2_1->SetLineColor( 2 );
h_1->Draw(  );
h2_1->Draw( "same" );
TLegend* legend = new TLegend(.12,.75,.27,.9);
legend->AddEntry(h_1, "bad region");
legend->AddEntry(h2_1, "good region");
legend->Draw();
...
h2_2->Draw( "same" );
TLegend* legend = new TLegend(.12,.75,.27,.9);
legend->AddEntry(h_2, "bad region");
legend->AddEntry(h2_2, "good region");
legend->Draw();
stringstream overlap;
